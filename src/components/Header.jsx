      ...
      <div className="container">
        <div className=" m-auto flex justify-between items-center ">
          <div className="logo links flex items-center justify-between w-1/2 px-10">
            ...
            <div className="w-full text-center h-2/3  content-center">
              ...
              <p className="text-gray-500 font-semibold">برای جسنجو حداقل 4 حرف نیاز است</p>
            </div>
             {/*  search section  in modal*/}
                ...
                <div className="modal-action">
                  <form method="dialog">
                    ...
                    <button className="btn fixed bottom-4 right-4 text-secondary font-bold ">بستن</button>
                  </form>
                </div>
              </div>
            </dialog>
        ...
        <div className="links mr-2  xl:flex pt-10  w-full justify-between hidden">
          ...
          <div className="ai_asemble px-4 relative">
            <button className="py-2 font-semibold bg-gray-500 text-white rounded-3xl  px-4 xl:px-7 text-base  xl:text-xl  ">سیستمتو بچین !</button>
          </div>
        </div>
