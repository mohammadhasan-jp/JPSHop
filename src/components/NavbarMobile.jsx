    ...
    <div className="navbarMobile">
      <div className="xl:hidden fixed bottom-0 z-40 py-3 flex w-screen justify-center bg-white rounded-sm shadow-2xl drop-shadow-2xl">
        {linksItems.map((item,index) => (
          <div className="navbarMobile__item mx-auto cursor-pointer" key={item.name}>
            ...
            <>
              ...
              <ModalBody className="overflow-scroll">
                {cartProducts.map((product, index) => (
                  <div key={index} className="flex product border-b-2 w-full pb-2">
                    ...
                    <div className="h-full">
                      ...
                      <div className="flex justify-between w-full px-4 items-center">
                        <div className="w-full">
                          <span className="text-black font-semibold text-xl">{product.price}</span>
                        </div>
                        <div className="border-t-2 border-b-2 border-primary flex gap-4 py-2 bg-white rounded-xl shadow-xl">
                          ...
                          <p className="content-center text-black text-2xl">{cartValue}</p>
                          <button
                            onClick={() => itemCountLimit(setCartValue, cartValue)}
              ...
              <ModalFooter>
                <div className="add_to_cart mb-1 shadow-lg h-[5rem] flex justify-between container bottom-0 z-30 px-6 pb-4 w-full">
                  <div className="w-full">
                    <p className="font-semibold text-base text-gray-600">مبلغ قابل پرداخت</p>
                    <p className="font-semibold text-xl text-green-600">8٬300٬000 تومان</p>
                  </div>
                  <button auto onClick={handleCardClick} className="btn bg-primary w-[14rem] text-base hover:bg-primary text-white py-2 rounded-lg h-full content-center">
                    <div className="flex">
